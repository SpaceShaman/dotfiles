if ask "Do you want to install apt packages?"; then
  ...
  sudo apt install -y curl fish git wget htop moc alacritty mc nodejs npm awesome compton rofi light pavucontrol playerctl scrot xclip ripgrep fd-find bat stow rsync python3-pip
